...
import com.litvak.mystore_lesson1.endpoint.GreetingEndpoint;
import com.litvak.mystore_lesson1.endpoint.OrdersEndpoint;
import com.litvak.mystore_lesson1.endpoint.ProductsEndpoint;
...
public class WebServiceConfig {
    ...
    @Bean(name = "orders")
    public DefaultWsdl11Definition orderssWsdlDefinition() {
        DefaultWsdl11Definition wsdl11Definition = new DefaultWsdl11Definition();
